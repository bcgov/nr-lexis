...
} from '../AppToastNotification'

describe('AppToastNotification', () => {
  afterEach(() => {
    vi.useRealTimers()
  ...
  it('renders in the global toast notification region', () => {
    const { container } = render(
      <main>
        <AppToastNotification kind="error" title="Upload error" subtitle="Upload failed." />
      </main>,
    )
  ...
  it('uses low-contrast toast styling by default', () => {
    render(<AppToastNotification kind="error" title="Upload error" subtitle="Upload failed." />)
  ...
  it('shows only the newest active notification without resurfacing the previous one', () => {
    const { rerender } = render(
      <>
        <AppToastNotification kind="warning" title="Earlier warning" subtitle="First message." />
        <AppToastNotification kind="error" title="Latest error" subtitle="Second message." />
      </>,
    )
