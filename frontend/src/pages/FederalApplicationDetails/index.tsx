...
const FEDERAL_APPLICATION_DETAIL_TAB_INDEX = {
  summary: 0,
  packages: 1,
  offers: 2,
  documents: 3,
...
const FederalApplicationDetailsPage = () => {
  ...
  const [selectedFederalApplicationTabIndex, setSelectedFederalApplicationTabIndex] = useState(
    FEDERAL_APPLICATION_DETAIL_TAB_INDEX.summary,
  )
  ...
  const onOpenApplicationUpload = useCallback(() => {
    ...
    setActionErrorMessage('')
    setActionInfoMessage('')
    setSelectedFederalApplicationTabIndex(FEDERAL_APPLICATION_DETAIL_TAB_INDEX.documents)
    window.setTimeout(() => {
      document
        .getElementById('federalApplicationDocumentUpload')
                        ...
                        <Table useZebraStyles>
                          ...
                          <TableBody>
                            ...
                            {filteredOffers.length === 0 && (
                              <TableRow>
                                <TableCell colSpan={2}>
                                  No offers matched the current filter.
                                </TableCell>
                              </TableRow>
                            )}
                          </TableBody>
